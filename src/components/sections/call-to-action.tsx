...
export function CallToAction() {
  return (
    <section className="relative py-24 lg:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(244,114,182,0.15),transparent_70%)]" />
        ...
        >
          ...
          >
            <p className="text-sm text-muted-foreground">
              ...
              <Link href="mailto:somyagarg270@gmail.com" className="text-primary underline hover:text-accent transition-colors">
                Email me directly
              </Link>{" "}
              or connect on{" "}
              <Link href="https://linkedin.com/in/somyagarg611" className="text-primary underline hover:text-accent transition-colors">
                LinkedIn
              </Link>.
            </p>
          </motion.div>
