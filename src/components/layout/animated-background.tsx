...
export function AnimatedBackground({ variant = 'default', className = '' }: AnimatedBackgroundProps) {
  ...
  if (!mounted) {
    return (
      <div className="fixed inset-0 -z-10 bg-gradient-to-br from-slate-950 via-purple-950/20 to-pink-950/20" />
    );
  }

  // Choose gradient based on variant - feminine rose/purple palette
  const gradient = variant === 'resume'
    ? 'linear-gradient(135deg, #0f0a1a 0%, #1a0f24 35%, #2d1b3d 70%, #4a1942 100%)'
    : 'linear-gradient(135deg, #0f0a1a 0%, #2d1b3d 50%, #4a1942 100%)';
